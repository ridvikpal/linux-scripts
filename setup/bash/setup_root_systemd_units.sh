...
# symlink the sync-monitor-gdm service file to the systemd system directory
...
# symlink the sync-monitor-gdm path file to the systemd system directory
...
# enable the new sync-monitor-gdm path file
